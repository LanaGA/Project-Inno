...
public interface IJenkinsDataService {
     ...
     */
// TODO: find a way to do this in an abstract class
    <T extends JenkinsModel<T>> Task<T> RequestAsync(URL component, String baseUrl, String userName, String apiKey, Object... parameters) {
